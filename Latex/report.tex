...
\textbf{Objective:} Manually verify the encryption process of the Hill Cipher by encrypting the first three letters of the dataset ``TOS'' using the project Key Matrix, showing every computational step.
...
\begin{equation}
    P = \begin{bmatrix} 19 \\ 14 \\ 18 \end{bmatrix}
\end{equation}

\subsection{Matrix Multiplication Step}
...
\begin{equation}
    ...
    k_{31} & k_{32} & k_{33} 
    \end{bmatrix} 
    \begin{bmatrix} 19 \\ 14 \\ 18 \end{bmatrix}
\end{equation}

Expanding the linear combinations:
\begin{align*}
    C_1 &= (19k_{11} + 14k_{12} + 18k_{13}) \pmod{26} \\
    C_2 &= (19k_{21} + 14k_{22} + 18k_{23}) \pmod{26} \\
    C_3 &= (19k_{31} + 14k_{32} + 18k_{33}) \pmod{26}
\end{align*}
